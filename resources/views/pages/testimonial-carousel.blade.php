@php
    $page_title = 'Testimonial Carousel';
@endphp
@include('layouts.header')
        ...
        <section class="page-header">
            ...
            <div class="container">
                <div class="page-header__inner">
                    <h1>Testimonial <span> Carousel</span></h1><div class="thm-breadcrumb__inner">
        ...
        <!-- Testimonial Carousel Page Start -->
                        ...
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-content">
                                    <p class="testimonial-one__client-name"><a href="/testimonials">Olivia Rose</a>
                                    </p>
                    ...
                    <div class="item">
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-content">
                                    <p class="testimonial-one__client-name"><a href="/testimonials">Michael
                                            James</a>
                                    </p>
                    ...
                    <div class="item">
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-content">
                                    <p class="testimonial-one__client-name"><a href="/testimonials">Liam
                                            Alexander</a>
                                    </p>
                    ...
                    <div class="item">
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-content">
                                    <p class="testimonial-one__client-name"><a href="/testimonials">Alex Hales</a>
                                    </p>
                                    <span class="testimonial-one__client-sub-title">Marketing Director</span>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="testimonial-one__single">
                            <div class="testimonial-one__client-info">
                                ...
                                <div class="testimonial-one__client-content">
                                    <p class="testimonial-one__client-name"><a href="/testimonials">Lima
                                            Rose</a>
                                    </p>
                                    <span class="testimonial-one__client-sub-title">Senior Software Engineer</span>
                                </div>
