    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-10">
                ...
                <p>Email: <a href="mailto:info@arsdeveloper.co.uk">info@arsdeveloper.co.uk</a><br>Phone: <a href="tel:+447478034328">+44 7478034328</a><br>Registered Office: {{ config('company.registered_office') }}</p>
